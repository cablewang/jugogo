...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'phone_size_name'); ?>
		<?php echo $form->textField($model,'phone_size_name',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'phone_size_name'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'large_size_name'); ?>
		<?php echo $form->textField($model,'large_size_name',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'large_size_name'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'ss_file_name'); ?>
		<?php echo $form->textField($model,'ss_file_name',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'ss_file_name'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'ss_thumb_name'); ?>
		<?php echo $form->textField($model,'ss_thumb_name',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'ss_thumb_name'); ?>
	</div>
